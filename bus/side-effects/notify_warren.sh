#!/usr/bin/env bash
# notify_warren.sh — macOS notification via terminal-notifier with full event context.
# Called for deploy, config-change, notification, and other events warranting Warren's attention.
set -euo pipefail
